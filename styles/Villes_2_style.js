...
function categories_Villes_2(feature, value, size, resolution, labelText,
                       ...
                       placement) {
                switch(value.toString()) {case 'Non':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(176,136,66,1.0)'})}),
